...
import { pgTable, index, uniqueIndex, foreignKey, integer, varchar, timestamp, serial, numeric, jsonb } from '@payloadcms/db-postgres/drizzle/pg-core'
...
export const payload_locked_documents_rels = pgTable('payload_locked_documents_rels', {
  ...
  mediaID: integer('media_id'),
    ...
    index('payload_locked_documents_rels_order_idx').on(columns.order), index('payload_locked_documents_rels_parent_idx').on(columns.parent), index('payload_locked_documents_rels_path_idx').on(columns.path), index('payload_locked_documents_rels_users_id_idx').on(columns.usersID), index('payload_locked_documents_rels_media_id_idx').on(columns.mediaID), foreignKey({
